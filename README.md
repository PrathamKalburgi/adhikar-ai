...
Trusted Dashboard — verified directives tracked to completion
        ↓
Alert System — automated deadline notifications via email
 ...
 * Verified directives are promoted into the trusted compliance dashboard workflow
...
### Alert System
 * Queries verified, un-complied directives with approaching deadlines (7-day threshold)
 * Automated email dispatch to respective department officers
 * Simulated fallback mode for local development and testing
## Demo Flow
 ...
 6. Trigger Alerts — dispatch upcoming deadline notifications to officers
## Tech Stack
| Layer | Technology |
|---|---|
...
| Database | PostgreSQL |
| Email / Alerts | Resend Python SDK |
## Project Structure
```text
adhikar-ai/
├── frontend/
...
DEMO_OFFICER_EMAIL=your_verified_resend_email@example.com
